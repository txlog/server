...
func TestAssetManager_UpsertAsset_NewAsset(t *testing.T) {
	...
	err = am.UpsertAsset(tx, hostname, machineID, timestamp, sql.NullBool{}, sql.NullString{}, "", "", sql.NullBool{}, sql.NullBool{}, sql.NullBool{})
	if err != nil {
...
func TestAssetManager_UpsertAsset_UpdateExisting(t *testing.T) {
	...
	// First insert
	err = am.UpsertAsset(tx, hostname, machineID, timestamp1, sql.NullBool{}, sql.NullString{}, "", "", sql.NullBool{}, sql.NullBool{}, sql.NullBool{})
	if err != nil {
		t.Fatalf("First UpsertAsset() failed: %v", err)
	}

	// Second update
	err = am.UpsertAsset(tx, hostname, machineID, timestamp2, sql.NullBool{}, sql.NullString{}, "", "", sql.NullBool{}, sql.NullBool{}, sql.NullBool{})
	if err != nil {
...
func TestAssetManager_UpsertAsset_ReplacesOldAsset(t *testing.T) {
	...
	// Insert old asset
	err = am.UpsertAsset(tx, hostname, oldMachineID, timestamp.Add(-2*time.Hour), sql.NullBool{}, sql.NullString{}, "", "", sql.NullBool{}, sql.NullBool{}, sql.NullBool{})
	if err != nil {
		t.Fatalf("Failed to insert old asset: %v", err)
	}

	// Insert new asset with same hostname
	err = am.UpsertAsset(tx, hostname, newMachineID, timestamp, sql.NullBool{}, sql.NullString{}, "", "", sql.NullBool{}, sql.NullBool{}, sql.NullBool{})
	if err != nil {
...
func TestAssetManager_UpsertAsset_ReactivatesInactive(t *testing.T) {
	...
	// Insert asset
	err = am.UpsertAsset(tx, hostname, machineID, timestamp.Add(-3*time.Hour), sql.NullBool{}, sql.NullString{}, "", "", sql.NullBool{}, sql.NullBool{}, sql.NullBool{})
	if err != nil {
...
func TestAssetManager_DeactivateAssetsByMachineID(t *testing.T) {
	...
	err = am.UpsertAsset(tx, hostname1, machineID, timestamp.Add(-1*time.Hour), sql.NullBool{}, sql.NullString{}, "", "", sql.NullBool{}, sql.NullBool{}, sql.NullBool{})
	if err != nil {
	...
	err = am.UpsertAsset(tx, hostname2, machineID, timestamp, sql.NullBool{}, sql.NullString{}, "", "", sql.NullBool{}, sql.NullBool{}, sql.NullBool{})
	if err != nil {
	...
	// This should deactivate the previous asset with the same hostname (Host2, ID)
	machineID2 := "test-machine-unique-id-2"
	err = am.UpsertAsset(tx, hostname2, machineID2, timestamp, sql.NullBool{}, sql.NullString{}, "", "", sql.NullBool{}, sql.NullBool{}, sql.NullBool{})
	if err != nil {
		t.Fatalf("Failed to insert asset 3: %v", err)
	}

	// Verify Host2/ID is NOW INACTIVE (Hostname duplication not allowed)
	err = tx.QueryRow("SELECT is_active FROM assets WHERE hostname = $1 AND machine_id = $2", hostname2, machineID).Scan(&isActive)
	if err != nil {
		t.Fatalf("Query failed: %v", err)
	}
	if isActive {
		t.Errorf("Expected asset 2 (Host2, ID) to be deactivated")
	}
